...
const BgNeonGlow = () => {
  return (
    <div className="relative h-full w-full bg-black">
      <div className="absolute inset-0 bg-[radial-gradient(circle_500px_at_50%_-30%,#ff00ff33,transparent)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_500px_at_80%_60%,#00ffff33,transparent)]" />
      <div className="absolute h-full w-full bg-[linear-gradient(to_right,#ffffff0a_1px,transparent_1px),linear-gradient(to_bottom,#ffffff0a_1px,transparent_1px)] bg-[size:32px_32px]" />
    </div>
  );
};
...
const BgGlassCard = () => {
  return (
    <div className="relative h-full w-full bg-gradient-to-br from-white to-gray-100">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:20px_20px]" />
      <div className="absolute left-1/4 top-1/4 h-48 w-48 rounded-2xl bg-gradient-to-br from-white/50 to-white/10 backdrop-blur-md" />
      <div className="absolute right-1/4 bottom-1/4 h-48 w-48 rounded-2xl bg-gradient-to-br from-white/50 to-white/10 backdrop-blur-md" />
    </div>
  );
};
  ...
  return (
    <div className="relative h-full w-full bg-white">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(at_80%_20%,#fecaca_0px,transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(at_20%_80%,#bfdbfe_0px,transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(at_80%_80%,#bbf7d0_0px,transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(at_20%_20%,#ddd6fe_0px,transparent_50%)]" />
      </div>
...
const BgPixelRain = () => {
  return (
    <div className="relative h-full w-full bg-gray-900">
      <div className="absolute inset-0 bg-[linear-gradient(0deg,#00000088_0%,transparent_100%)]" />
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#4f4f4f0f_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f0f_1px,transparent_1px)] bg-[size:8px_8px] animate-[rain_2s_linear_infinite]" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,#000000_100%)]" />
    </div>
  );
};
...
export const BACKGROUND_OPTIONS = [
  ...
  {
    name: "Pixel Rain",
    component: <BgPixelRain />,
    theme: "dark",
  },

  {
    name: "Neon Glow",
    component: <BgNeonGlow />,
    theme: "dark",
  },
  {
    name: "Glass Card",
    component: <BgGlassCard />,
    theme: "light",
  },
  {
    name: "Rainbow Mesh",
    component: <BgRainbowMesh />,
    theme: "light",
  },
] as const;
